...
def run_AMR(path_to_contigs,samples,abricate_output):
    ...
    for sample in samples :
        ...
        subprocess.run(". $CONDA_PREFIX/epi/home/ashita.jawali@kdhe.state.ks.us/mambaforge/etc/profile.d/conda.sh && conda activate CRAB && abricate "+path_to_contigs+"/"+sample+"/scaffolds.fasta > "+abricate_output+"/"+sample+"_AMRgenes.tsv",shell= True)
